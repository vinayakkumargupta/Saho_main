...
public class SearchExample3 {
    ...
    public SearchExample3(Context context, MapView mapView) {
        ...
        camera.lookAt(new GeoCoordinates(28.70333529343719, 76.86743551761116), mapMeasureZoom);
    ...
    private void geocodeAnAddress() {
        ...
        GeoCoordinates geoCoordinates = new GeoCoordinates( 28.70333529343719, 76.86743551761116);
